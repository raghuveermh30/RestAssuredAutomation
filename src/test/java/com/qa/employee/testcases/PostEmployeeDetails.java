...
public class PostEmployeeDetails extends TestBaseAPI{
	...
	public void getEmployees() {
		...
		httpResponse = httpRequest.request(Method.POST,"/create");
		delay();
	...
	public void tearDown() {
		logger.info("***************** posting the each employee test is finished *******");
	}
